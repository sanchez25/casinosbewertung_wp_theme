				...
				<div class="page-left">
					<div class="page-cards-slots providers">
						<?php
							...
							$catlist = get_terms('country',$args);
							foreach ($catlist as $cat) {
								echo '<div class="main-slots-item page">';
									echo '<a class="main-slots-item-link providers" href="'.get_term_link($cat->slug, 'country').'">';
										echo '<div class="main-slots-block-image page-providers">';
											echo '<img src="'.z_taxonomy_image_url($cat->term_id, 'pay_cards').'" />';
											echo '<div class="main-slots-block-back">';
												echo '<h3 class="play-title-provider">'.$cat->name.'</h3>';
